...
class PyMikado(PythonPackage):
    ...
    #url      = "https://github.com/EI-CoreBioinformatics/mikado/archive/2.0prc2.tar.gz"
    git      = "git://github.com/EI-CoreBioinformatics/mikado"

    #version('2.0rc6', sha256='b2a24856baf3097eaf22015732c523b30123a3c01b942101fd7d84af200632b3')
